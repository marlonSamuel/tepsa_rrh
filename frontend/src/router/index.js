...
import PlanillaFijoInfo from '@/components/pago_fijos/Info'
...
const routes = [
    ...
    { path: '/planilla_fijo_info/:id', name: 'PlanillaFijoInfo', component: PlanillaFijoInfo, beforeEnter: multiguard([isLoggedIn]) },
]
